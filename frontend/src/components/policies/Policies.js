...
const Policies = () => {
  return (
    <>
      <div className="mx-[5%] sm:mx[11%] md:mx-[12%] md:px-[12px] lg:mx-[1.5%] lg:px-[17px] xl:mx-[7%] xl:px-[20px] my-[50px] ">
        <div className="grid lg:grid-cols-4 sm:grid-cols-2 border border-slate-200">
          <Policy
            url="images/policies/policiesImg01.png"
            heading="Free Shipping"
            para="On all orders over $75.00"
          />

          <Policy
            url="images/policies/policiesImg02.png"
            heading="Free Returns"
            para="Returns are free within 9 days"
          />
          <Policy
            url="images/policies/policiesImg03.png"
            heading="100% Payment Secure"
            para="Your payment are safe with us."
          />
          <Policy
            url="images/policies/policiesImg04.png"
