...
const MiddleHeader = () => {
  ...
  const stickNavbar = () => {
    if (window !== undefined) {
      ...
      windowHeight > 280
        ? setStickyClass(
            "fixed top-0 left-0 z-10 bg-white shadow-lg animate-fade-in-down-nav origin-top w-full lg:hidden  "
          )
            ...
            <div
              className={`flex justify-between ${
                stickyClass !== "relative"
                  ? "mx-[5%] sm:mx[11%] md:mx-[12%] md:px-[12px] lg:mx-0 lg:px-0"
                  : ""
              } `}
            >
              <div className="flex justify-center items-center">
                <Link to="/">
                  {/* <img className="" src="./images/logo.png" alt="quadb" /> */}
                    <p className="text-xl md:text-3xl">E Commerce</p>
                </Link>
              </div>
              <div className=" grid content-center ">
                <div className="flex justify-end ">
                  ...
                  <div className=" grid content-center lg:pr-0 sm:pr-7 pr-2">
                    <Cart />
                  </div>
